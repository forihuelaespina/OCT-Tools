...
File: IOT_GUI_MeasureThicknessParameterSettings.py

Class IOT_GUI_MeasureThicknessParameterSettings
...
## Class description
class IOT_GUI_MeasureThicknessParameterSettings(QGroupBox):
    #Sphinx documentation
    """A GUI to control the parameters of the :class:`IOT_OperationMeasureLayerThickness`.
    
    A GUI to control the parameters of the :class:`IOT_OperationMeasureLayerThickness`.
    

    .. seealso:: :class:`IOT_PerfilometerParameterSettings`
    .. note:: None
    .. todo:: None
