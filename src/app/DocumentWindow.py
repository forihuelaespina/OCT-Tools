...
+-------------+--------+------------------------------------------------------+
|  3-Mar-2018 | FOE    | - Solved circular importing with UtilitiesDock.      |
...
#                tmp.windowHalfWidth = settingsGUI.getWidthValue()
    ...
    def openDocument(self):
        """Initializes an :class:`octant.data.Document` and opens a OCT image to work on.
        ...
        if fileName: #Empty strings evaluate to false in Python;
            ...
            tmp.study = octant.data.OCTscan(img)
